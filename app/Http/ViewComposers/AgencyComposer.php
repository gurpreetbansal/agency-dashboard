...
class AgencyComposer
{
	...
	public function compose(View $view) {
		...
		if((Auth::user() != null)){
			...
			if(Request::segment(1) == 'project-detail' && Request::segment(2) <> 'sidebar'){
			...
			if(Request::segment(1) == 'download' && (Request::segment(2) == 'seo' || Request::segment(2) == 'livekeyword') ){
		...
		$view->with(['profile_data'=> $domain_details,'allCampaigns'=>$allCampaigns,'dashboard'=>$dashboard,'role_id'=>$role_id,'dashboardTypes'=>$dashboardTypes, 'announcements'=>$announcements,'user_package'=>$user_package,'project_count'=>$project_count,'notifications'=>$notifications]);
	}
