...
<ul class="all-pages-con">
    <li class="{{ $filter == 'critical' ? 'active': ''  }}" ><a href="javascript:;" class="light-red-bg p-1 viewPages" data-filter="critical"><span class="uk-text-medium">All Criticals</span> <span class="no">{{ array_sum($errorsListing['critical']) }}</span></a></li>
    @endif         
    <li class="{{ $key == $filter ? 'active': ''  }}" > <a href="javascript:;" class="viewPages" data-filter="{{ $key }}" > <span>{{ $auditLevel[$key] }}</span> <span class="no">{{ $value }}</span> </a></li>
...
@if($counterNotZero == 0)
<ul class="all-pages-con">
    <li class="{{ $filter == 'warning' ? 'active': ''  }}" > <a href="javascript:;" class="light-orange-bg p-1 viewPages" data-filter="warning" > <span class="uk-text-medium">All Warnings</span> <span class="no">{{ array_sum($errorsListing['warning']) }}</span></a></li>
    @endif         
    <li class="{{ $key == $filter ? 'active': ''  }}" ><a href="javascript:;" class="viewPages" data-filter="{{ $key }}" ><span>{{ $auditLevel[$key] }}</span> <span class="no">{{ $value }}</span></a></li>
...
@if($counterNotZero == 0)
<ul class="all-pages-con">
    <li class="{{ $filter == 'notices' ? 'active': ''  }}" ><a href="javascript:;" class="light-blue-bg p-1 viewPages" data-filter="notices" ><span class="uk-text-medium">All Notices</span> <span class="no">{{ array_sum($errorsListing['notices']) }}</span></a></li>
    @endif         
    <li class="{{ $key == $filter ? 'active': ''  }}" ><a href="javascript:;" class="viewPages" data-filter="{{ $key }}" ><span>{{ $auditLevel[$key] }}</span> <span class="no">{{ $value }}</span></a></li>
