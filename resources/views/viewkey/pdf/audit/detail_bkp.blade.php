		                ...
		                <tr>
		                    <td>
		                    	<article class="ads">
							      	<h6>
							        	<small>
							          		<a href="javascript:;">{{ str_replace('/',' ',preg_replace( "#^[^:/.]*[:/]+#i", "", $summaryTask['url'])) }}</a>
						        		</small>
		                    ...
		                    <td>
		                    	<div class="color-bar">
			                        ...
			                        <div class="color-bar-inner">
			                            ...
			                            @foreach($valuesDesktop['originLoadingExperience']['metrics']['FIRST_INPUT_DELAY_MS']['distributions']
			                            as $key => $value)
			                            @if($key == 0)
			                            <span class="green-light" style="flex-grow: {{ round($value['proportion'] * 100) }}">{{ round($value['proportion'] * 100) }}%</span>
			                            @elseif($key == 1)
		                    ...
		                    <td>
		                    	<div class="color-bar">
			                        ...
			                        <div class="color-bar-inner">
			                            ...
			                            @foreach($valuesDesktop['originLoadingExperience']['metrics']['LARGEST_CONTENTFUL_PAINT_MS']['distributions']
			                            as $key => $value)
			                            @if($key == 0)
			                            <span class="green-light" style="flex-grow: {{ round($value['proportion'] * 100) }}">{{ round($value['proportion'] * 100) }}%</span>
			                            @elseif($key == 1)
		                    ...
		                    <td>
		                    	<div class="color-bar">
			                        ...
			                        <div class="color-bar-inner">
			                            ...
			                            @foreach($valuesDesktop['originLoadingExperience']['metrics']['CUMULATIVE_LAYOUT_SHIFT_SCORE']['distributions']
			                            as $key => $value)
			                            @if($key == 0)
			                            <span class="green-light" style="flex-grow: {{ round($value['proportion'] * 100) }}">{{ round($value['proportion'] * 100) }}%</span>
			                            @elseif($key == 1)
		                    ...
		                    <td>
		                    	<div class="color-bar">
			                        ...
			                        <div class="color-bar-inner">
			                            ...
			                            @foreach($valuesMobile['originLoadingExperience']['metrics']['FIRST_INPUT_DELAY_MS']['distributions']
			                            as $key => $value)
			                            @if($key == 0)
			                            <span class="green-light" style="flex-grow: {{ round($value['proportion'] * 100) }}">{{ round($value['proportion'] * 100) }}%</span>
			                            @elseif($key == 1)
		                    ...
		                    <td>
		                    	<div class="color-bar">
			                        ...
			                        <div class="color-bar-inner">
			                            ...
			                            @foreach($valuesMobile['originLoadingExperience']['metrics']['LARGEST_CONTENTFUL_PAINT_MS']['distributions']
			                            as $key => $value)
			                            @if($key == 0)
			                            <span class="green-light" style="flex-grow: {{ round($value['proportion'] * 100) }}">{{ round($value['proportion'] * 100) }}%</span>
			                            @elseif($key == 1)
		                    ...
		                    <td>
		                    	<div class="color-bar">
			                        ...
			                        <div class="color-bar-inner">
			                            ...
			                            @foreach($valuesMobile['originLoadingExperience']['metrics']['CUMULATIVE_LAYOUT_SHIFT_SCORE']['distributions']
			                            as $key => $value)
			                            @if($key == 0)
			                            <span class="green-light" style="flex-grow: {{ round($value['proportion'] * 100) }}">{{ round($value['proportion'] * 100) }}%</span>
			                            @elseif($key == 1)
