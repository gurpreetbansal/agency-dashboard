<input type="hidden" id="viewActivitylimit" value="10">
<input type="hidden" id="viewActivitypage" value="1">
<input type="hidden" id="viewActivitydate" value="{{ date('Y-m') }}">

<div class="main-data-view" id="activity">
	<div class="white-box mb-40 active" id="view-activity-side" >
		 <div class="white-box-head">
		    ...
		    <div class="right">
		        <div class="filter-list activity-filter-list">
		            <ul>
		                <li>
		                    <button type="button" id="calendar-label-side" class="btn btn-sm btn-border">
