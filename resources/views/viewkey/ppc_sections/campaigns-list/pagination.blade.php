...
<div class="pagination ads_campaign">
   @if ($results->hasPages())
   <ul class="pagination" role="navigation">
      ...
      @endif
      <?php
         $start = $results->currentPage() - 2; // show 3 pagination links before current
         $end = $results->currentPage() + 2; // show 3 pagination links after current
         if($start < 1) {
