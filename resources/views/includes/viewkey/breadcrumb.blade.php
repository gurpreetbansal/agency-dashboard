...
<div class="project-detail-header" id="projectdetailheader">
	<div class="elem-left ajax-loader">
		...
		<h3>{{ @$profile_data->host_url }}
			<a href="//{{ @$profile_data->domain_url }}" target="_blank"> <i class="fa fa-external-link"></i></a>
	...
	<div class="elem-right ajax-loader">
		<div class="project-manager-detail" id="agency-contact-info">
			...
			<ul>
				<!-- <li><a href="tel:{{ @$profile_data['ProfileInfo']->contact_no }}"><i class="fa fa-phone"></i><?php if(isset($profile_data->ProfileInfo->contact_no)){ echo $profile_data->ProfileInfo->contact_no;}else{ echo "Agency Phone Number";}?></a></li> -->
