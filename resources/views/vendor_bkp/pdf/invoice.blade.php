								...
								<table cellspacing="0" border="0" cellpadding="0" width="100%">
									<thead style="background: #327aee;">
										<tr>
											...
											<td style="width:35%; font-family: 'Roboto', sans-serif; padding: 15px 20px 15px 20px; color:#fff; font-size:14px; font-weight: bold;">
									...
									<tbody>
										<tr>
											...
											<td style="font-family: 'Roboto', sans-serif; font-size:14px; padding: 15px 20px 15px 20px; color:#242424; border-bottom: 1px solid rgba(0,0,0,0.1); font-weight: normal;">1</td>
											<td style="font-family: 'Roboto', sans-serif; font-size:14px; padding: 15px 20px 15px 20px; color:#242424; border-bottom: 1px solid rgba(0,0,0,0.1); font-weight: normal;">
												${{number_format((@$lines['data'][0]['amount']/100),2)}}
											</td>
										</tr>
										<tr>
									...
									<tfoot style="background: rgba(50, 122, 238, 0.1);">
										<tr>
											...
											<td style="font-family: 'Roboto', sans-serif; font-size:14px; padding: 15px 20px 15px 20px; color:#242424; font-weight: normal;">
												${{number_format(@$amount_remaining/100,2)}}
											</td>
										</tr>
									</tfoot>
								</table>
