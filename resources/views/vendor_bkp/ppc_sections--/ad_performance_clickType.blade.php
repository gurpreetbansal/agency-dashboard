    ...
    <div class="left">
      <div class="heading">
        ...
        <h2>Performance Click Types
          <span uk-tooltip="title:  Performance Click Type Here...; pos: top-left" class="fa fa-info-circle"
    ...
    <div class="project-table-cover">
      <div class="project-table-head">
        ...
        <div class="project-search ajax-loader">
          <form>
            <input type="text" placeholder="Search..." class="performance-clickType-search">
            <button type="submit">
