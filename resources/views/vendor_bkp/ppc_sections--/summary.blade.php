  ...
  <div class="white-box-head">
    <div class="left">
        <div class="heading ajax-loader">
          ...
          <div>
            <h2>Google Ads - Summary<span uk-tooltip="title: Google Ads - Summary Here...; pos: top-left" class="fa fa-info-circle"></span></h2>
        ...
        <div class="white-box small-chart-box ">
          ...
          <div class="small-chart-box-head">
            ...
            <h6 class="sv-overview ajax-loader"><big class="compare impressions-ads">0</big> Impressions <span
              uk-tooltip="title: Impressions ADS Here...; pos: top-left" class="fa fa-info-circle"></span>
            </h6>
          </div>
        ...
        <div class="uk-width-1-4@xl uk-width-1-4@l uk-width-1-2@m">
          <div class="white-box small-chart-box ">
            ...
            <div class="small-chart-box-head">
              ...
              <h6 class="sv-overview ajax-loader"><big class="compare click-ads">0</big> Clicks <span uk-tooltip="title: Click ADS Here...; pos: top-left"
            ...
            <div class="white-box small-chart-box ">
              ...
              <div class="small-chart-box-head">
                <figure class="sv-overview ajax-loader">
                  ...
                  <h6 class="sv-overview ajax-loader"><big class="compare ctr-ads">0%</big> CTR<span uk-tooltip="title: CTR ADS Here...; pos: top-left"
                  class="fa fa-info-circle"></span></h6>
                </div>
      ...
      <div class="uk-width-1-4@xl uk-width-1-4@l uk-width-1-2@m">
        <div class="white-box small-chart-box ">
          ...
          <div class="small-chart-box-head">
            ...
            <h6 class="sv-overview ajax-loader"><big class="compare cost-ads">$0</big> Cost <span uk-tooltip="title: Cost ADS Here...; pos: top-left"
              class="fa fa-info-circle"></span></h6>
            </div>
            ...
            <div class="white-box small-chart-box ">
              ...
              <div class="small-chart-box-head">
                ...
                <h6 class="sv-overview ajax-loader"><big class="compare average-cpc-ads">$0.00</big> Average CPC<span
                  uk-tooltip="title: Average CPC ADS Here...; pos: top-left" class="fa fa-info-circle"></span>
                </h6>
              </div>
              ...
              <div class="white-box small-chart-box ">
                ...
                <div class="small-chart-box-head">
                  ...
                  <h6 class="sv-overview ajax-loader"><big class="compare conversion-ads">00</big> Conversions<span
                    uk-tooltip="title: Conversions ADS Here...; pos: top-left" class="fa fa-info-circle"></span>
                  </h6>
                </div>
              ...
              <div class="white-box small-chart-box ">
                ...
                <div class="small-chart-box-head">
                  ...
                  <h6 class="sv-overview ajax-loader"><big class="compare conversion-rate-ads">0.00%</big> Conversion Rate <span
                    uk-tooltip="title: Conversion Rate ADS Here...; pos: top-left"
                    class="fa fa-info-circle"></span></h6>
                  </div>
              ...
              <div class="uk-width-1-4@xl uk-width-1-4@l uk-width-1-2@m">
                <div class="white-box small-chart-box ">
                  ...
                  <div class="small-chart-box-head">
                    ...
                    <h6 class="sv-overview ajax-loader"><big class="compare cost-per-conversion-rate-ads">00</big> Cost Per Conversion  <span
                      uk-tooltip="title: Cost Pr Conversion Rate Here...; pos: top-left"
                      class="fa fa-info-circle"></span></h6>
                    </div>
