    ...
    <div class="white-box-head">
        ...
        <div class="left">
            <div class="heading">
                ...
                <h2>Project Activity
                    <span uk-tooltip="title:  It shows a list of activities (or tasks) performed under the campaign. Click and add more. ; pos: top-left"
                    ...
                    <div>
                        ...
                        <article>
                            <form method="post" class="activitiesLoad" id="activitiesLoad" enctype="multipart/form-data">
                                ...
                                <div class="act-status">
                                    <select class="select form-control selectpicker" id="activity_status" name="status" >
