<div class="audit-white-box mb-40 pa-0 target-detail" id="issues_overview">
    ...
    <div class="audit-box-body">
        ...
        <div class="border-bottom py-4">
            ...
            <div class="px-4 py-2">
                <div class="uk-grid">
                    <div class="uk-width-2-4"><img src="{{ URL::asset('public/vendor/internal-pages/images/cross-icon.png') }}" class="sub-2 mr-1" alt="" /> {{ $auditLevel[$keyName] }}</div>
...
<div class="audit-white-box mb-40 pa-0 target-detail" id="content_optimization">
    <div class="audit-box-head">
        <h2><img src="{{ URL::asset('public/vendor/internal-pages/images/content-opti-icon.png') }}" alt="" /> Content optimization</h2>
    </div>
    <div class="audit-box-body">
        <div class="border-bottom py-4">
                ...
                <li>
                    ...
                    <div class="uk-accordion-content p-4 mt-0">
                        <p>Check how your page might appear in Google search results. Google search results
                            ...
                            Learn more on how snippets are created in <a href="https://developers.google.com/search/docs/advanced/appearance/good-titles-snippets#how-snippets-are-created" target="_blank">this Google guide</a>.
                        </p>
                    </div>
                </li>
            </ul>
                ...
                <div class="uk-grid">
                    <div class="uk-width-1-1">
                        <div class="bg-grey p-3 border uk-border-rounded">
                            <p class="mb-0">
                                {{ str_replace('/',' > ',preg_replace( "#^[^:/.]*[:/]+#i", "", rtrim($summaryTask['url'],"/ "))) }}
                            </p>
        ...
        <div class="border-bottom py-4 htags">
            ...
            <div class="px-4 py-2">
                ...
                <ul class="tags-accordion uk-accordion">
                    <li>
                        ...
                        @if($htagCounter > 10)
                        <a class="uk-accordion-action tags-accordion-action" href="javascript:;"> <span uk-icon="icon:triangle-down" class="uk-icon text-secondary"></span> <font>Show All</font></a>
                        @endif
                    </li>
                </ul>
                    @endif
...
<div class="audit-white-box mb-40 pa-0 target-detail" id="structure_data">
    <div class="audit-box-head">
