...
<div class="tabs site-audit-breadcrum">
    ...
    <div class="btn-group">
        <a href="javascript:;" class="btn icon-btn color-orange site-audit-renew" id="site-audit-renew" uk-tooltip="title: Initiate new crawl; pos: top-center">
        ...
        <!-- <a target="_blank" href="{{url('/project-settings/'.$campaign_id)}}" data-type="seo" class="btn icon-btn color-red audit-pdf" uk-tooltip="title: Generate PDF File; pos: top-center"><img src="{{ URL::asset('/public/vendor/internal-pages/images/pdf-icon.png') }}"></a> -->
        ...
        <div class="audit-box-body">
            ...
            <div class="audit-issues">
                <ul class="uk-subnav uk-subnav-pill" uk-switcher="connect: .auditIssuesContainer">
                    <li class="uk-active"><a href="javascript:;" aria-expanded="true" class="ajax-loader h-39"></a></li>
                    <li><a href="javascript:;" aria-expanded="false" class="ajax-loader h-39"></a></li>
                    <li><a href="javascript:;" aria-expanded="false" class="ajax-loader h-39"></a></li>
                    <li><a href="javascript:;" aria-expanded="false" class="ajax-loader h-39"></a></li> 
                    <li><a href="javascript:;" aria-expanded="false" class="ajax-loader h-39"></a></li>
                </ul>
