<div class="audit-white-box mb-40 pa-0 target-detail" id="search_optimization">
    ...
    <div class="audit-box-body">
        ...
        <div class="audit-white-box mb-40 pa-0 target-detail" id="images">
            <div class="audit-box-head">
        ...
        <div class="audit-white-box mb-40 pa-0 target-detail" id="links">
            <div class="audit-box-head">
            ...
            <div class="audit-box-body">
                ...
                <div class="border-bottom py-4 show-more-audit-extlinksexpand">
                    ...
                    <div class="px-4 py-2">
                        ...
                        @if(count($externalLinks['items']) > 6)
                        <div class="audit-box-foot">
                ...
                <div class="border-bottom py-4 show-more-audit-intlinksexpand">
                    ...
                    <div class="px-4 py-2">
                        <table class="uk-table mb-0 uk-table-middle">
                         ...
                         @if(count($internalLinks['items']) > 6)
                        <div class="audit-box-foot">
