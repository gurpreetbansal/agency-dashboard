...
<tr class="<?php if($key%2==0){ echo 'odd';}else{ echo 'even';}?>">
  <td>
    ...
    <p><strong>Target:</strong>
      ...
      <?php if($record->nofollow == 'follow'){?>
    <span class="follow-status" uk-tooltip="title: Follow; pos: top-left">F</span>
    <?php }else{ ?>
    <span class="follow-status" uk-tooltip="title: NoFollow; pos: top-left">NF</span>
  <?php }?>
  </td>
