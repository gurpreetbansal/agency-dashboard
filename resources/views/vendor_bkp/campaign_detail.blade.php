...
<div class="project-detail-body">
	...
	<div class="tabs">
		...
		<ul class="uk-subnav uk-subnav-pill" uk-switcher="connect: .projectNavContainer">
		...
		<div class="download-options">
			<div class="btn-group">
				...
				@if(isset($audit) && $audit == 'run')
				<a href="{{url('/site-audit/'.$campaign_id)}}" target="_blank" class="btn icon-btn color-blue site-audit-icon" uk-tooltip="title: Run Site Audit; pos: top-center">
					<img src="{{URL::asset('public/vendor/internal-pages/images/run-site-audit.png')}}">
				</a>
				@elseif(isset($audit) && $audit == 'check')
				<a href="{{url('/site-audit/'.$campaign_id)}}" target="_blank" class="btn icon-btn color-green site-audit-icon" uk-tooltip="title: Check Site Audit; pos: top-center">
					<img src="{{URL::asset('public/vendor/internal-pages/images/check-site-audit.png')}}">
				</a>
				@endif
				
				<a href="{{ url('/download/pdf/'.@$keyenc.'/seo') }}" target="_blank" data-type="seo" class="btn icon-btn color-red generate-pdf" uk-tooltip="title: Generate PDF File; pos: top-center"><img src="{{URL::asset('public/vendor/internal-pages/images/pdf-icon.png')}}"></a>
				@if(Auth::user()->role_id !=4)
				...
				@endif
				<a href="javascript:;" id="ShareKey" data-id="{{$campaign_id}}" class="btn icon-btn color-purple" uk-tooltip="title: Generate Shared Key; pos: top-center"><img src="{{URL::asset('public/vendor/internal-pages/images/share-key-icon.png')}}"></a>
