    ...
    <div class="icons-list">
        @if (in_array("1", explode(',',$value->dashboard_type)))
                    <!-- <a href="javascript:;" uk-tooltip="title:Google Analytics; pos: top-center" class="<?php if(empty($value->google_analytics_id)){ echo 'inactive'; }?>"><img
                        ...
                        <a href="javascript:;" uk-tooltip="title:Google Analytics; pos: top-center" class="<?php if(empty($value->google_analytics_id)){ echo 'inactive'; }?>"><img src='{{URL::asset("/public/vendor/internal-pages/images/google_analytics_icon.png")}}'></a>
                        @endif
                        @if(!empty($value->ga4_email_id))
                        <a href="javascript:;" uk-tooltip="title:Google Analytics; pos: top-center" class="<?php if(empty($value->ga4_email_id)){ echo 'inactive'; }?>"><img src='{{URL::asset("/public/vendor/internal-pages/images/archived-ga4-icon.png")}}'></a>
                        @endif
