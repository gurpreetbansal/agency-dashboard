...
@if(isset($dashboardtype) && (empty($dashboardtype->google_ads_id)) && (empty($dashboardtype->google_ads_campaign_id)) && ($dashboardtype->ppc_skip == 0))
<div class="wizardSection col-lg-12 col-md-12">
	@include('vendor.dashboards.ppc_wizard')
</div>
@else
				...
				<div class="card-body">
					...
					<div class="row">
						<div class="col-md-6">
							...
							<input type="text" class="form-control firstdaterange" name="dateranges" value="">
						</div>
					...
					<input type="hidden" class="sd" value="{{@$moduleadsStatus->start_date}}">
					<input type="hidden" class="ed" value="{{@$moduleadsStatus->end_date}}">
					<input type="hidden" class="csd" value="{{@$moduleadsStatus->compare_start_date}}">
					<input type="hidden" class="ced" value="{{@$moduleadsStatus->compare_end_date}}">
					<!-- Default switch -->
					<div class="custom-control custom-switch">
						<input type="checkbox" class="custom-control-input btn btn-primary" id="customSwitchesppc" <?php if(!empty($moduleadsStatus->compare_start_date) && $moduleadsStatus->compare_start_date !=null){ echo "checked";}?>/>
						<label class="custom-control-label" for="customSwitchesppc">Compare</label>
					</div>

					<div class="compareSection" style="<?php if(!empty($moduleadsStatus->compare_start_date) && $moduleadsStatus->compare_start_date !=null){ echo "display:block;"; }else{ echo "display:none;"; }?>">
						<div class="row">	
							<div class="col-md-6">
								<label>Compare Date Range</label>		
								<input type="text" class="form-control seconddaterange" name="dateranges1" id="reportrange">
							</div>
	...
	<div class="col-md-12 col-lg-6 col-xl-12">
		<div class="mb-3 card">
			<div class="card-body">
				...
				<!--loader-->
				<canvas id="canvasppcsummary" height="300"></canvas>
			</div>
		</div>
	</div>
</div>
