					...
					<div class="right">
						...
						<div class="btn-group">
            				<a href="{{url('/generate_organic_keyword_excel/'.$campaign_id)}}"  target="_blank" class="btn icon-btn color-green" uk-tooltip="title: Generate Excel File; pos: top-center" aria-expanded="false"><img src="{{URL::asset('public/vendor/internal-pages/images/excel-icon.png')}}"></a>
       						<a href="javascript:;" data-request-id="{{@$campaign_id}}" id="refresh_organic_keyword_growth" class="btn icon-btn color-purple" uk-tooltip="title: Refresh Organic Keyword Growth; pos: top-center" title="" aria-expanded="false"><img src="{{URL::asset('/public/vendor/internal-pages/images/refresh-icon.png')}}"></a>
        				</div>
					</div>
				</div>
