...
<div class="dateRange-popup" id="ga4-goals-dateRange-popup">
<form>
  ...
  <div class="dateRange-fields">
    ...
    <div class="form-group uk-flex <?php if(@$ga4_comparison == 0){echo 'ga4-hidden-previous-datepicker';}?>" id="ga4-goals-previous-section">
