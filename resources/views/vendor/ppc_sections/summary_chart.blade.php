 ...
 <div class="white-box pa-0  mb-40">
    ...
    <div class="left">
      <div class="heading ajax-loader">
        ...
        <h2>Summary
          <span uk-tooltip="title: Take a look at the progress of the PPC campaign over a period of time. ; pos: top-left" class="fa fa-info-circle" title="" aria-expanded="false"></span>
        </h2>
      </div>
    </div>
    </div>
