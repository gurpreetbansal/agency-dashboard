 ...
 <div class="white-box pa-0 mb-40">
  <div class="progress-loader" style="display:none;"> </div>
  ...
  <div class="white-box-body">
    <div uk-grid>
      ...
      <!-- Chart Box 1 -->
      <div class="uk-width-1-4@xl uk-width-1-4@l uk-width-1-2@m">
        <div class="white-box small-chart-box ">

          <div class="small-chart-box-head">
            <figure class="sv-overview ajax-loader">
              <img src="{{URL::asset('public/vendor/internal-pages/images/google-ads-icon.png')}}">
            </figure>
          ...
          <div class="small-chart-box-foot percentage-values">
            <p class="sv-overview sv-overview-avg ajax-loader"> <cite class="impressions-ads-percentage"><span uk-icon="icon: "></span>0%</cite></p>
          </div>
        </div>
      </div>
      <!-- Chart Box 1 End -->
        ...
        <div class="uk-width-1-4@xl uk-width-1-4@l uk-width-1-2@m">
          <div class="white-box small-chart-box ">
            ...
            <div class="small-chart-box-head">
              ...
              <h6 class="sv-overview ajax-loader">
                <big class="compare click-ads">0</big> Clicks <span uk-tooltip="title: It indicates how many times an ad was clicked.; pos: top-left" class="fa fa-info-circle"></span>
              </h6>
              </div>
              ...
              <div class="small-chart-box-foot percentage-values">
                <p class="sv-overview sv-overview-avg ajax-loader"> <cite class="clicks-ads-percentage"><span uk-icon="icon: "></span>0%</cite></p>
              </div>
            </div>
          </div>
          <!-- Chart Box 3 End -->
            ...
            <div class="white-box small-chart-box ">
              ...
              <div class="small-chart-box-head">
                <figure class="sv-overview ajax-loader">
                  ...
                  <h6 class="sv-overview ajax-loader"><big class="compare ctr-ads">0%</big> CTR <span uk-tooltip="title: It is a performance metric that displays how often people click on your ad after it has been displayed.; pos: top-left"  class="fa fa-info-circle"></span></h6>
                </div>
                ...
                <div class="small-chart-box-foot percentage-values">
                  <p class="sv-overview sv-overview-avg ajax-loader"> <cite class="ctr-ads-percentage"><span uk-icon="icon: "></span>0%</cite></p>
                </div>
              </div>
            </div>
            <!-- Chart Box 5 End -->
      ...
      <div class="uk-width-1-4@xl uk-width-1-4@l uk-width-1-2@m">
        <div class="white-box small-chart-box ">
          ...
          <div class="small-chart-box-head">
            ...
            <h6 class="sv-overview ajax-loader"><big class="compare cost-ads"><small>USD</small>0</big> Cost <span uk-tooltip="title: It is the sum of your cost per click (CPC) spend.; pos: top-left"
            ...
            <div class="small-chart-box-foot percentage-values">
              <p class="sv-overview sv-overview-avg ajax-loader"> <cite class="cost-ads-percentage"><span uk-icon="icon: "></span>0%</cite></p>
            </div>
          </div>
        </div>
        <!-- Chart Box 2 End -->
          ...
          <div class="uk-width-1-4@xl uk-width-1-4@l uk-width-1-2@m">
            <div class="white-box small-chart-box ">
              ...
              <div class="small-chart-box-head">
                ...
                <h6 class="sv-overview ajax-loader"><big class="compare average-cpc-ads"><small>USD</small>0.00</big> Average CPC <span
              ...
              <div class="small-chart-box-foot percentage-values">
                <p class="sv-overview sv-overview-avg ajax-loader"> <cite class="average-cpc-ads-percentage"><span uk-icon="icon: "></span>0%</cite></p>
              </div>
            </div>
          </div>
          <!-- Chart Box 4 End -->
            ...
            <div class="uk-width-1-4@xl uk-width-1-4@l uk-width-1-2@m">
              <div class="white-box small-chart-box ">
                ...
                <div class="small-chart-box-foot percentage-values">
                  <p class="sv-overview sv-overview-avg ajax-loader"> <cite class="conversion-ads-percentage"><span uk-icon="icon: "></span>0%</cite></p>
                </div>
              </div>
            </div>
            <!-- Chart Box 6 End -->
              ...
              <div class="white-box small-chart-box ">
                ...
                <div class="small-chart-box-head">
                  ...
                  <h6 class="sv-overview ajax-loader"><big class="compare conversion-rate-ads">0.00%</big> Conversion Rate <span
                    uk-tooltip="title: It is calculated by simply taking the number of conversions dividing it by the number of total impressions during the same time period.; pos: top-left"
                    class="fa fa-info-circle"></span></h6>
                  </div>
                  ...
                  <div class="small-chart-box-foot percentage-values" >
                    <p class="sv-overview sv-overview-avg ajax-loader"> <cite class="conversion-rate-ads-percentage"><span uk-icon="icon: "></span>0%</cite></p>
                  </div>
                </div>
              </div>
              <!-- Chart Box 7 End -->
              ...
              <div class="uk-width-1-4@xl uk-width-1-4@l uk-width-1-2@m">
                <div class="white-box small-chart-box ">
                  ...
                  <div class="small-chart-box-head">
                    ...
                    <h6 class="sv-overview ajax-loader"><big class="compare cost-per-conversion-rate-ads"><small>USD</small>00</big> Cost Per Conversion  <span
                    ...
                    <div class="small-chart-box-foot percentage-values" >
                      <p class="sv-overview sv-overview-avg ajax-loader"> <cite class="cost-per-conversion-rate-ads-percentage"><span uk-icon="icon: "></span>0%</cite></p>
                    </div>
                  </div>
                </div>
                <!-- Chart Box 8 End -->
