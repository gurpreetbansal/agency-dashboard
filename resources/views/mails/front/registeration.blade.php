            ...
            <tr>
                ...
                <tr>
                    <td style="padding: 20px 0; text-align: center">
                        <a href="{{url('/')}}">
                            <img src="{{URL::asset('/public/front/img/logo-email.png')}}" aria-hidden="true" width="108"
                            height="63" alt="agencydashboard-logo"
                            border="0"
                            style="height: auto; background: #f0f0f0; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                        </a>
                    </td>
                </tr>
            </table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td style="padding:20px 40px 40px 40px; text-align: left;  font-family:'Poppins', -apple-system, BlinkMacSystemFont, Helvetica, Arial, sans-serif; color:#2e343b; font-size:13.5px; font-weight:300; letter-spacing:0.07em; line-height:2em;">
                                ...
                                <br><br>
                                Thanks for joining. We're really excited to have you on board.
                                <br>
                                <strong>100's</strong> of professionals worldwide use Agency Dashboard to share meaningful reports with their customers.
                                <br><br><br>
                                <!-- Button : BEGIN -->
                                <table role="presentation" aria-hidden="true" cellspacing="0" cellpadding="0" border="0"
...
<tr>
    <td bgcolor="#ffffff">
        ...
        <tbody>
            <tr>
                <td style="padding:10px 40px 40px 40px; text-align: left;  font-family:'Poppins', -apple-system, BlinkMacSystemFont, Helvetica, Arial, sans-serif; color:#2e343b; font-size:13.5px; font-weight:300; letter-spacing:0.07em; line-height:2em;">
                    <strong>Have a question?</strong>
                    <p style="margin: 0px 0px 10px 0px; font-family:'Poppins', -apple-system, BlinkMacSystemFont, Helvetica, Arial, sans-serif; color:#2e343b; font-size:13.5px; font-weight:300; letter-spacing:0.07em; line-height:2em;">
                        Check our
                        <a href="javascript:;" target="_blank"
                        style="color:#37c2ef; text-decoration: underline;">Knowledge Base</a>
                        for a quick answer.
                    </p>
                    <p style="margin: 0px 0px 10px 0px; font-family:'Poppins', -apple-system, BlinkMacSystemFont, Helvetica, Arial, sans-serif; color:#2e343b; font-size:13.5px; font-weight:300; letter-spacing:0.07em; line-height:2em;">
                        You can always contact our
                        <a href="javascript:;" target="_blank" style="color: #37c2ef; text-decoration: underline;">24/7
                        support team</a>
                    via live chat and email. We will be happy to help you!</p>
                </td>
            </tr>
        </tbody>
    </table>
...
<tr>
    ...
    © <?php echo date('Y');?> Agency Dashboard. All rights reserved.<br>Plot-22 & 23, 3rd Floor, Block-D DLF IT Park, Chandigarh,
    (0172) 466-6470
</td>
</tr>
<tr>
    ...
    <tbody>
        <tr>
            <td align="center" style="padding:0 10px 0 10px"><a
                href="https://www.facebook.com/agencydashboard"
                ...
                target="_blank">
                <img src="{{URL::asset('/public/front/img/facebook-email-icon.png')}}"
                width="32" class=""
                style="max-width:100%;height:auto;border:none"></a></td>

                <td align="center" style="padding:0 10px 0 10px"><a
                    href="https://www.instagram.com/agencydashboard"
                    style="color:#499df3;font-family:'Open Sans',Helvetica,Arial,sans-serif;font-size:13px;font-weight:normal;line-height:100%;text-decoration:none"
                    target="_blank">
                    <img src="{{URL::asset('/public/front/img/instagram-email-icon.png')}}"
                    width="30" class=""
                    style="max-width:100%;height:auto;border:none"></a></td>
                    <td align="center" style="padding:0 10px 0 10px"><a
                        href="https://twitter.com/AgencyDashboard"
                        style="color:#499df3;font-family:'Open Sans',Helvetica,Arial,sans-serif;font-size:13px;font-weight:normal;line-height:100%;text-decoration:none"
                        target="_blank">
                        <img src="{{URL::asset('/public/front/img/twitter-email-icon.png')}}"
                        width="30" class=""
                        style="max-width:100%;height:auto;border:none"></a></td>
    ...
    <tr>
        ...
        class="x-gmail-data-detectors">
        You received this email because you signed up for Agency Dashboard
        <br>
    </td>
</tr>
</table>
