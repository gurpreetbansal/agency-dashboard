<html>
<head>
    <title>Balance Alert - Data For Seo</title>
                ...
                <table cellspacing="0" border="0" align="center" cellpadding="10" width="100%" style="padding:40px;">
                    <tr>
                        <td style="padding:0px;">
                            <h3 style="font-family: 'Roboto', sans-serif; font-weight: 400; margin-top: 0px; margin-bottom: 15px;">Hi Shruti Dhiman,</h3>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:0px;">
                            <p style="font-family: 'Roboto', sans-serif; font-weight: 400; margin-top: 0px; margin-bottom: 15px;">
                                You're running out of your balance.
                                Current balance is $<strong>{{$balance}}</strong>.
                            </p>
                        </td>
                    </tr>
