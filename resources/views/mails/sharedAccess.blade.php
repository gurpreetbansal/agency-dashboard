                ...
                <table cellspacing="0" border="0" align="center" cellpadding="10" width="100%" style="padding:40px;">
                    <tr>
                        <td style="padding:0px;">
                            <h3 style="font-family: 'Roboto', sans-serif; font-weight: 400; margin-top: 0px; margin-bottom: 15px;">Hi {{$name}},</h3>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:0px;">
                            <p style="font-family: 'Roboto', sans-serif; font-weight: 400; margin-top: 0px; margin-bottom: 15px;">
                                ...
                                <a href="{{$link}}"><button class="btn btn-primary">Click Here to Login</button></a>
                            </p>
                        </td>
                    </tr>
