<html>
<head>
    <title>Refund from Agency Dashboard</title>
        ...
        <tr>
            <td>
                ...
                <table cellspacing="0" border="0" align="center" cellpadding="10" width="100%" style="padding:40px;">
                    ...
                    @if(isset($refund_detail) && !empty($refund_detail))
                    @foreach($refund_detail as $detail)
                    <table class="inventory">
                        <thead>
                            <tr>
                                <th><span>Refund on <?php echo date('M d, Y',strtotime($detail->refund_created_on));?></span></th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td><span>${{$detail->amount}}</span></td>
                            </tr>
                        </tbody>
                    </table>
                    @endforeach
                    ...
                    <table class="inventory">
                        ...
                        <tbody>
                            <tr>
                                <td><span>${{$amount - $adjusted_total}}</span></td>
                            </tr>
                        </tbody>
                    </table>
