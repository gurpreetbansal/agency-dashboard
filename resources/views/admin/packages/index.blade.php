                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Name</th><th>Description</th><th>Amount(Monthly|Yearly)</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($packages as $item)
                                    <tr>
                                        ...
                                        <td>{{ '$'.$item->monthly_amount .' | '.'$'. $item->yearly_amount}}</td>
                                        <td>
                                           <!--  <a href="{{ url('/admin/packages/' . $item->id) }}" title="View Package"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a> -->
                                            <a href="{{ url('/admin/packages/' . $item->id . '/edit') }}" title="Edit Package"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
